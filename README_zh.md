...
> **"把 `https://github.com/chenly255/2sigma` 克隆到 `~/.codex/skills/2sigma/`"**

其他 agent（Trae 等）：把 `SKILL.md` 和 `references/` 复制到 agent 读取 skill 的目录即可。
...
**陈立颖** — [中山大学](https://www.sysu.edu.cn/) & [广州国家实验室](https://www.gzlab.ac.cn/) 博士生

导师：[田鲁亦 教授](https://scholar.google.com.au/citations?user=6G0fn6QAAAAJ&hl=en)
